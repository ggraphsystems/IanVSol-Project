...
export default function Login() {
    ...
    return (
        <section className="pt-44 text-white mx-auto max-w-sm overflow-hidden rounded-xl shadow-md sm:max-w-md md:max-w-3xl lg:max-w-6xl 2xl:max-w-6xl">
            <div className="font-mono ml-70 text-sm space-y-6 sm:px-2 md:px-1 lg:px-0 2xl:px-10 text-white">
                    <h3
            ...
            <div className="pt-10 grid lg:ml-80 md:grid-cols-2 gap-16 item-center">
                <form>
                    <TextInput
                        label="Email"
                        type="email"
                    ...
                    />
                    <div className="pt-10 mr-10 mb-2 md:grid md:grid-cols-2">
                     <button
                        type="button"
                        onClick={signInUser}
                        className={`w-40 ml-25 p-3 text-white bg-neutral-900 hover:scale-105 hover:bg-neutral-800 hover:text-white rounded-xl transition-all duration-200 ease-in-out active:scale-95 focus:outline-none focus:ring-2 focus:ring-purple-500 inline-block [--tw-text-opacity:1]
                            active:bg-purple-600 active:text-white focus:text-white focus:bg-purple-600`}>
                            Log in
                    </button>
                     <a
                        href=''
                        className={`w-40 ml-25 p-3 pl-8 text-black bg-neutral-100 hover:scale-105 hover:bg-purple-600 hover:text-white rounded-xl transition-all duration-200 ease-in-out active:scale-95 focus:outline-none focus:ring-2 focus:ring-purple-500 inline-block [--tw-text-opacity:1]
                            active:bg-purple-600 active:text-white focus:text-white focus:bg-purple-600`}>
                            Go Ian V Sol
                    </a>
