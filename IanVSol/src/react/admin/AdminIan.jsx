...
export default function Admin() {
    ...
    return(
        <section className="mx-auto max-w-sm overflow-hidden rounded-xl shadow-md sm:max-w-md md:max-w-3xl lg:max-w-6xl 2xl:max-w-6xl">
            ...
            <section className="pt-25 md:pt-28 mx-auto max-w-sm overflow-hidden rounded-xl shadow-md sm:max-w-md md:max-w-3xl lg:max-w-4xl lg:ml-40 2xl:ml-10 2xl:max-w-6xl">
