        ...
        >
            ...
            <div className="space-y-6 md:pb-18 ml-3 text-white">
                ...
                <button
                    ...
                    className={`p-2 px-2 md:mr-3 lg:ml-17 2xl:ml-43 sm:ml-27 text-sm ml-1 bg-white hover:bg-purple-500 hover:scale-105 transition-all duration-200 ease-in-out text-black hover:text-white rounded-xl [--tw-text-opacity:1]
