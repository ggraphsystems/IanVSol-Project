...
export default function ServicesForm() {
    ...
    return (
        ...
        <div className="px-0 -ml-1 lg:ml-20 grid md:grid-cols-2 gap-16 lg:mr-18 item-center">
            <div class="-space-y-6 pt-5 mr-3 ml-3 text-white">
                ...
                <div class="gap-5 pt-15 ml-2 md:pt-0 md:ml-6">
                    ...
                    <p
                    class="ml-3 -mb-5 pt-5 w-85 md:ml-0 md:w-base text-neutral-300 px-2 pb-30 md:pb-6 lg:pb-20 text-sm md:text-sm lg:-ml-2 lg:w-110 2xl:w-md text-text-secondary-light dark:text-text-secondary-dark"
                    >
                ...
                <form onSubmit={handleSubmit}>
                    <div className="font-mono text-sm space-y-6 pt-6 sm:px-2 md:px-3 lg:px-0 2xl:px-10 text-white">
                        ...
                        <p
                        class="w-80 ml-5 -mb-12 md:mb-3 lg:-mb-8 md:ml-0 md:w-base text-neutral-300 px-2 pb-30 md:pb-1 lg:pb-10 text-sm md:text-sm 2xl:w-lg lg:-ml-1 text-text-secondary-light dark:text-text-secondary-dark"
                        >
